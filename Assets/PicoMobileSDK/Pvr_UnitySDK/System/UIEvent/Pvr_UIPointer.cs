...
public class Pvr_UIPointer : MonoBehaviour {
    ...
    public virtual bool IsSelectionButtonPressed()
    {
        ...
        if (Pvr_ControllerManager.controllerlink.goblinserviceStarted)
        {
            ...
            triggerPressed= Pvr_UnitySDKAPI.Controller.UPvr_GetKey(0, Pvr_UnitySDKAPI.Pvr_KeyCode.TRIGGER);
        }
        return Input.GetMouseButton(0) || Input.GetKey(KeyCode.JoystickButton0) || controllerValue || triggerPressed;    
    }
